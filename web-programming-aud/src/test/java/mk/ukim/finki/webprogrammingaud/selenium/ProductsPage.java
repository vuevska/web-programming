package mk.ukim.finki.webprogrammingaud.selenium;
...
public class ProductsPage extends AbstractPage {
    ...
    public void assertElements(int productsNumber, int deleteButtons, int editButtons, int cartButtons, int addButtons) {
        ...
        Assert.assertEquals("delete does not match", deleteButtons, this.getDeleteButtons().size());
        Assert.assertEquals("edit does not match", editButtons, this.getEditButtons().size());
        Assert.assertEquals("cart does not match", cartButtons, this.getCartButtons().size());
